...
$endif$
  ...
  \vspace{0.5cm}
  $for(author)$$author.name$ (\IfLanguageName{english}{Matr.-Nr.}{Matr.-Nr.} $author.studid$)\\[-0.1em]{\normalsize $author.discipline$, \nth{$author.semester$} Semester}\\[-0.1em]{\normalsize $author.university$}$sep$\\[0.6em]$endfor$
  \end{center}
  \vspace{4cm}

  \noindent\begin{minipage}[t]{0.34\textwidth}
\IfLanguageName{english}{Reviewer(s):}{Gutachter:}
\end{minipage}
\begin{minipage}[t]{0.63\textwidth}
$for(supervisor)$$supervisor$$sep$\\[0.1em]$endfor$
\end{minipage}
...
\par\noindent\makebox[2.25in][l]{} \hfill\makebox[2.25in][c]{$for(author)$$author.name$$sep$, $endfor$}%
